  ...
  return (
    <div className="p-6 space-y-6 max-w-2xl mx-auto">
      ...
      <PageHeader 
        ...
        subtitle={getText('आपकी आध्यात्मिक यात्रा', 'Your Spiritual Journey')} 
      />
      ...
      <div className="grid grid-cols-2 gap-4">
        <Card className="spiritual-card">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-sm text-muted-foreground">{getText('आज के तप', "Today's Taps")}</div>
          </CardContent>
        </Card>
        ...
        <Card className="spiritual-card">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-sm text-muted-foreground">{getText('आज के जप', "Today's Japa")}</div>
          </CardContent>
        </Card>
      </div>
        ...
        <Card className="spiritual-card">
          <CardHeader className="pb-2">
            <CardTitle className="flex items-center text-lg">
              ...
              {getText('दैनिक लक्ष्य', 'Daily Goal')}
            </CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="spiritual-card">
          <CardHeader className="pb-2">
            <CardTitle className="flex items-center text-lg">
              ...
              {getText('मासिक लक्ष्य', 'Monthly Goal')}
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
        ...
        <Card className="spiritual-card">
          <CardHeader className="pb-2">
            <CardTitle className="flex items-center text-lg">
              ...
              {getText('वार्षिक लक्ष्य', 'Yearly Goal')}
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span>{stats.yearlyJaps} / {stats.yearlyTarget} {getText('जप', 'Japa')}</span>
        ...
        <Card className="spiritual-card">
          <CardHeader className="pb-2">
            <CardTitle className="flex items-center text-lg">
              ...
              {getText('निरंतरता', 'Streak')}
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-center">
              <div className="text-3xl font-bold text-primary mb-1">{stats.currentStreak}</div>
              <div className="text-sm text-muted-foreground">{getText('दिन लगातार', 'Days in a row')}</div>
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="spiritual-card">
        <CardContent className="p-6 text-center">
          <blockquote className="text-lg italic text-foreground mb-2">
            {getText('"मन को शांत करें, एक माला एक बार में।"', '"Calm the mind, one mala at a time."')}
          </blockquote>
          <div className="text-sm text-muted-foreground">- {getText('धार्मिक जप काउंटर', 'Spiritual Japa Counter')}</div>
        </CardContent>
      </Card>
    </div>
  );
